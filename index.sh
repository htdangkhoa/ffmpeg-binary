...
echo 'linux amd64'
echo '  downloading from johnvansickle.com'
download 'https://johnvansickle.com/ffmpeg/releases/ffmpeg-release-amd64-static.tar.xz' linux-amd64.tar.xz
echo '  extracting'
mkdir -p ffmpeg/linux-amd64
tar -xf linux-amd64.tar.xz -C ffmpeg/linux-amd64 --strip-components=1
